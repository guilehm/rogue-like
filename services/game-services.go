...
func (s *GameService) CreateEnemies() {
	s.Hub.Enemies = append(s.Hub.Enemies,
		s.createEnemy(models.Orc, 184, 24, 30),
		s.createEnemy(models.Orc, 192, 72, 30),
		s.createEnemy(models.Orc, 128, 40, 30),
		s.createEnemy(models.Orc, 288, 32, 30),
		s.createEnemy(models.Orc, 184, 96, 30),
		s.createEnemy(models.Orc, 88, 64, 30),
